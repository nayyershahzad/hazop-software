...
export const PIDViewer = ({ studyId, selectedNodeId, onNodeMarked }: PIDViewerProps) => {
  ...
  const loadPIDFile = async (pidId: string) => {
    ...
    console.log('Loading P&ID from URL:', url);
    setPdfUrl(url);
  };
              ...
              <div className="flex-1 overflow-auto p-4 bg-gray-50">
                ...
                >
                  <Document
                    ...
                    error={<div className="text-center py-8 text-red-600">Failed to load PDF. Check console for details.</div>}
                  >
                    <Page
